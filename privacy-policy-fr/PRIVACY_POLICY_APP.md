...
- Selon l’audit : l’application utilise l’endpoint d’ingestion `https://us.i.posthog.com` (ce qui peut impliquer un transfert vers les États-Unis selon la configuration du compte/région PostHog).
...
- PostHog : l’application utilise l’endpoint d’ingestion `https://us.i.posthog.com`, ce qui peut impliquer des transferts en dehors de l’EEE.
