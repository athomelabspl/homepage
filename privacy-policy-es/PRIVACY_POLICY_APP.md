...
- Del análisis: la aplicación tiene configurado el endpoint de ingest `https://us.i.posthog.com` (lo que puede implicar transferencias a EE. UU. según la configuración de la cuenta/región de PostHog).
...
- PostHog: la aplicación usa el endpoint de ingest `https://us.i.posthog.com`, lo que puede implicar transferencias fuera del EEE.
