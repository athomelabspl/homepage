...
## Attention has to be deliberate
...
The useful thing to copy isn't the distance itself — it's the discipline distance forces: noticing something specific, holding onto it, and bringing it back up later in a way that shows you remembered. That's a habit, not a circumstance. It works exactly the same whether your partner is a ten-hour flight away or asleep on the other side of the bed.

Most of what makes someone feel cared for isn't proximity. It's evidence that you were paying attention when it would have been easier not to. Long-distance couples don't have a choice about that. Everyone else does — which is exactly why it's worth building on purpose.
