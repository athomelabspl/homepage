...
cluster: readiness
role: pillar
primaryQuery: "am I ready to date after a breakup"
relatedKeys:
  - can-you-be-friends-with-your-ex
  - ex-moved-on-quickly-new-relationship
...
<BlogFigure
  photo={{
    ...
    alt: 'Empty chair at a wooden table with a glass of iced coffee',
    credit: 'Geertje Caliguire',
    creditUrl: 'https://unsplash.com/@geertjecaliguire',
    photoUrl: 'https://unsplash.com/photos/Bwtdcy6AUcA',
  }}
/>
...
If friendship is the real question, see [can you be friends with your ex](/breakup-reset/blog/en/can-you-be-friends-with-your-ex/). If they moved on first and you feel stuck, [when your ex moves on first](/breakup-reset/blog/en/ex-moved-on-quickly-new-relationship/) speaks to that shock.
