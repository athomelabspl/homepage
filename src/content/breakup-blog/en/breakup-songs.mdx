...
role: satellite
primaryQuery: "breakup songs by how you feel"
relatedKeys:
...
<YouTubeEmbed id="r3p3G0tZunE" title='Lauryn Hill — "Ex-Factor" (Official Audio)' />
...
<YouTubeEmbed id="GPMcwzESL7I" title='Carrie Underwood — "Before He Cheats" (Official Audio)' />
...
<YouTubeEmbed id="b6WNdcZpDhQ" title='Billie Eilish — "when the party&apos;s over" (Official Audio)' />
...
<YouTubeEmbed id="gm-Y9idMMQ4" title='Coldplay — "The Scientist" (Official Audio)' />
...
<YouTubeEmbed id="OrF_brR_IIQ" title='Lorde — "Liability" (Official Audio)' />
...
For when you need more than background noise, [how to cope when you cannot stop thinking about them](/breakup-reset/blog/en/how-to-cope-with-a-breakup/) walks through what else can interrupt the loops. If you feel flat more than sad, see [feeling numb after a breakup](/breakup-reset/blog/en/feeling-numb-after-breakup/). If you want a steadier first week, start with [what to do after a breakup](/breakup-reset/blog/en/what-to-do-after-a-breakup/).
