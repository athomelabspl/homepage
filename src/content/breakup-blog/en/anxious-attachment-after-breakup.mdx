...
For more on why the replaying loop feels so real, [how to cope with a breakup when you cannot stop thinking about them](/breakup-reset/blog/en/how-to-cope-with-a-breakup/) goes deeper into that pattern. For the specific question of whether to reach out at all, [no contact after a breakup](/breakup-reset/blog/en/no-contact-after-breakup/) is worth reading before you decide.
