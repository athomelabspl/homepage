...
cluster: attachment
role: pillar
primaryQuery: "anxious attachment after breakup"
relatedKeys:
...
For more on why the replaying loop feels so real, [how to cope with a breakup when you cannot stop thinking about them](/breakup-reset/blog/en/how-to-cope-with-a-breakup/) goes deeper into that pattern. If your grief looks more like shutdown than reaching, see [avoidant attachment after a breakup](/breakup-reset/blog/en/avoidant-attachment-after-breakup/). For the question of whether to reach out at all, [no contact after a breakup](/breakup-reset/blog/en/no-contact-after-breakup/) is worth reading before you decide. If you are wondering whether friendship is realistic yet, the [Am I ready to be friends with my ex? quiz](/breakup-reset/blog/en/friends-with-ex-quiz/) can help you see whether you are still attached or actually ready.
