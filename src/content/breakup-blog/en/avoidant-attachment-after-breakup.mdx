...
cluster: attachment
role: satellite
primaryQuery: "avoidant attachment after breakup"
relatedKeys:
  - anxious-attachment-after-breakup
  - feeling-numb-after-breakup
  - emotional-shutdown-after-breakup
cover:
...
If you want to read about what the deferred response can look like in practice, [feeling numb after a breakup](/breakup-reset/blog/en/feeling-numb-after-breakup/) covers the early flat period: when feelings have not arrived yet and what that usually means. For the reaching side of attachment after loss, start with [anxious attachment after a breakup](/breakup-reset/blog/en/anxious-attachment-after-breakup/).
