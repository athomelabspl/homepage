...
role: satellite
primaryQuery: "how to cope with breakup intrusive thoughts"
relatedKeys:
  - what-to-do-after-a-breakup
  - urge-to-text-ex-how-to-stop
  - breakup-anxiety-at-night
cover:
...
This is one of the most common parts of a breakup. People talk about the crying and the missing. They talk less about the way your mind will not leave you alone.

Here the focus is the loop itself: what interrupts it when thoughts keep coming back. For timelines, see [getting over a breakup](/breakup-reset/blog/en/getting-over-a-breakup/). For the first week, see [what to do after a breakup](/breakup-reset/blog/en/what-to-do-after-a-breakup/).

The thoughts coming back is not a sign something is going wrong.
...
<BlogFigure
  photo={{
    ...
    alt: 'Person writing in a notebook with a cup of coffee nearby',
    credit: 'Thought Catalog',
    creditUrl: 'https://unsplash.com/@thoughtcatalog',
    photoUrl: 'https://unsplash.com/photos/505eectW54k',
  }}
/>
...
If the urge to send a message is loud right now, [what to do in the next 10 minutes if you want to text your ex](/breakup-reset/blog/en/urge-to-text-ex-how-to-stop/) can help you ride it out. If nights are when it hits hardest, see [breakup anxiety at night](/breakup-reset/blog/en/breakup-anxiety-at-night/).
