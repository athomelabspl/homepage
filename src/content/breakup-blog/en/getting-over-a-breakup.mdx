...
role: satellite
primaryQuery: "how long to get over a breakup research"
relatedKeys:
...
Here the focus is simpler: how long recovery tends to take, and what the evidence actually shows.

If you need first-week steps, start with [what to do after a breakup](/breakup-reset/blog/en/what-to-do-after-a-breakup/). If the thoughts will not stop, see [how to cope when you cannot stop thinking about them](/breakup-reset/blog/en/how-to-cope-with-a-breakup/). If you feel like you are going backwards, see [how to heal when progress feels circular](/breakup-reset/blog/en/how-to-heal-from-a-breakup/).
...
<BlogFigure
  photo={{
    ...
    alt: 'Two friends sitting on a bench talking outdoors',
    credit: 'The Unmistakables',
    creditUrl: 'https://unsplash.com/@theunmistakables',
    photoUrl: 'https://unsplash.com/photos/qQq5mIaZ1FE',
  }}
/>
...
If you are wondering whether to start dating again, [what research says about dating after a breakup](/breakup-reset/blog/en/am-i-ready-to-date-after-a-breakup/) looks at rebound studies and motivation without a three-month rule.
