...
cluster: no-contact
role: pillar
primaryQuery: "no contact after a breakup"
relatedKeys:
...
If full silence is not realistic because you share children, a workplace, or a tight friend group, [should you do no contact](/breakup-reset/blog/en/should-you-do-no-contact/) walks through low-contact options that still protect your recovery. Not sure where you stand? The [Should I do no contact? quiz](/breakup-reset/blog/en/should-i-do-no-contact-quiz/) checks whether you need full silence or tighter boundaries, including kids, pets, or a lease. If you are weighing friendship instead of distance, the [Am I ready to be friends with my ex? quiz](/breakup-reset/blog/en/friends-with-ex-quiz/) checks whether you are still attached or actually ready.
...
If you are wondering how long to keep going, see [how long should no contact last](/breakup-reset/blog/en/how-long-is-the-no-contact-rule-after-breakup/). When the urge spikes, [keeping no contact when it feels impossible](/breakup-reset/blog/en/keeping-no-contact-after-breakup/) and [what to do in the next 10 minutes if you want to text](/breakup-reset/blog/en/urge-to-text-ex-how-to-stop/) are more practical. If full silence is not possible, try [low contact](/breakup-reset/blog/en/low-contact-after-breakup/) or [mute vs block](/breakup-reset/blog/en/should-i-block-my-ex-or-mute/).
