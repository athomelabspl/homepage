...
cluster: no-contact
role: satellite
primaryQuery: "how long should no contact last"
relatedKeys:
...
faq:
  ...
  - question: "How long until no contact gets easier?"
    answer: "Many people find the first week the hardest, with some relief often showing up around weeks two and three. Sorting through what happened can take longer, and your timeline will not match a chart exactly."
...
<BlogFigure
  photo={{
    ...
    alt: 'Person walking alone on a path through an autumn forest',
    credit: 'Katarzyna Zygnerska',
    creditUrl: 'https://unsplash.com/@katasha',
    photoUrl: 'https://unsplash.com/photos/cgM-RMKDfGQ',
  }}
/>
