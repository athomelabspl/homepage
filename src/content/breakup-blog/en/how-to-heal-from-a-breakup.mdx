...
<BlogFigure
  photo={{
    ...
    alt: 'Person walking alone on a forest path toward soft light',
    credit: 'Ewan Z',
...
If you want the wider research picture on timelines and what recovery tends to look like, [getting over a breakup](/breakup-reset/blog/en/getting-over-a-breakup/) goes into that in more depth.
