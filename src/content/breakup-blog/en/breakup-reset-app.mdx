...
cluster: product
role: commercial
primaryQuery: "breakup reset app"
relatedKeys:
  - what-to-do-after-a-breakup
  - no-contact-after-breakup
  - breakup-journaling-prompts-privacy
cover:
...
Breakup Reset is a **free** mobile app on **Android** and **iOS**. No ads. No subscription for core features.
...
**Breakup Reset** is the name of this app. Other products may use similar phrases. On **Google Play** and the **App Store**, look for the publisher **At Home Labs**. Free to try. No account required to start the quiz.
