...
- Z audytu: w aplikacji ustawiony jest endpoint ingest `https://us.i.posthog.com` (co może oznaczać transfer do USA w zależności od konfiguracji konta/regionu PostHog).
...
- PostHog: aplikacja ma ustawiony endpoint ingest `https://us.i.posthog.com`, co może wiązać się z przekazywaniem danych poza EOG.
